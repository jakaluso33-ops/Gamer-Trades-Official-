      ...
      <div className="retro-card" style={{ padding: '32px', width: '100%', maxWidth: '380px' }}>
        ...
        {mode === 'verify' ? (
          <form onSubmit={verifyCode} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <div style={{ fontSize: '11px', color: '#ffd700', textShadow: '0 0 6px #ffd700', marginBottom: '4px' }}>
              ✉ CONFIRM YOUR EMAIL
            </div>
            {info && (
              <div style={{ fontSize: '10px', color: '#64748b', lineHeight: 1.8 }}>{info}</div>
            )}
            <div>
            ...
            <div>
              <label style={{ fontSize: '10px', color: '#64748b', display: 'block', marginBottom: '4px' }}>6-DIGIT CODE</label>
              <input
                type="text"
                inputMode="numeric"
                ...
                placeholder="123456"
                style={{ ...inputStyle, letterSpacing: '4px', textAlign: 'center', fontSize: '12px' }}
              />
            </div>
          ...
          <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            {mode === 'signin' && (
              <button
                ...
                style={{ background: 'none', border: 'none', color: '#64748b', fontSize: '9px', cursor: 'pointer', textAlign: 'center' }}
              >
