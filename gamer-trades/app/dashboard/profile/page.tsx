  ...
  return (
    <div className="grid-bg" style={{ minHeight: '100%' }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '6px' }}>
            <div>
              ...
              <div style={{ fontSize: '12px', color: '#64748b' }}>Joined {joinDate} · {totalTrades} trades</div>
            </div>
            <div style={{ padding: '4px 10px', background: '#64748b22', border: '2px solid #64748b', fontSize: '12px', color: '#64748b' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', marginTop: '6px' }}>
            {[
              ...
              <div key={s.k} style={{ textAlign: 'center', padding: '5px 10px', background: '#0a0e1a', border: '1px solid #1e3a5f' }}>
                <div style={{ fontSize: '11px', color: '#64748b', marginBottom: '3px' }}>{s.k}</div>
                <div style={{ fontSize: '14px', color: s.c, textShadow: `0 0 6px ${s.c}` }}>{s.v}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      {tab === 'stats' && (
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
          <div className="retro-card" style={{ padding: '14px' }}>
            <div style={{ fontSize: '13px', color: '#00aaff', textShadow: '0 0 8px #00aaff', marginBottom: '10px' }}>TRADING PERFORMANCE</div>
            {[
              ...
              <div key={k} style={{ display: 'flex', justifyContent: 'space-between', padding: '4px 0', borderBottom: '1px solid #0f1629', fontSize: '12px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            <div className="retro-card" style={{ padding: '14px' }}>
              <div style={{ fontSize: '13px', color: '#8b5cf6', textShadow: '0 0 8px #8b5cf6', marginBottom: '10px' }}>AI BATTLE RECORD</div>
            ...
            <div className="retro-card" style={{ padding: '14px' }}>
              <div style={{ fontSize: '13px', color: '#ffd700', textShadow: '0 0 8px #ffd700', marginBottom: '8px' }}>EQUITY CURVE</div>
      ...
      {tab === 'achievements' && (
        <div>
          ...
          <div className="retro-card" style={{ padding: '14px', marginTop: '14px', borderColor: '#ffd70044', boxShadow: '4px 4px 0 #000, 0 0 8px #ffd70022' }}>
            <div style={{ fontSize: '13px', color: '#ffd700', marginBottom: '8px' }}>🏅 NEXT TO UNLOCK</div>
      ...
      {tab === 'settings' && (
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '12px' }}>
          <div className="retro-card" style={{ padding: '14px' }}>
            <div style={{ fontSize: '13px', color: '#8b5cf6', textShadow: '0 0 8px #8b5cf6', marginBottom: '12px' }}>GAME SETTINGS</div>
            {[
              ...
              <div key={s.k} style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px 0', borderBottom: '1px solid #0f1629' }}>
                <span style={{ fontSize: '12px', color: '#e2e8f0' }}>{s.k}</span>
                <button
                  onClick={s.toggle}
                  style={{
            ...
            <div style={{ marginTop: '10px' }}>
              <div style={{ fontSize: '12px', color: '#64748b', marginBottom: '6px' }}>VISUAL THEME</div>
          ...
          <div className="retro-card" style={{ padding: '14px' }}>
            <div style={{ fontSize: '13px', color: '#00aaff', textShadow: '0 0 8px #00aaff', marginBottom: '12px' }}>ACCOUNT</div>
            {[
              ...
              <div key={k} style={{ display: 'flex', justifyContent: 'space-between', padding: '7px 0', borderBottom: '1px solid #0f1629', fontSize: '12px' }}>
                <span style={{ color: '#64748b' }}>{k}</span>
                <span style={{ color: '#e2e8f0' }}>{v}</span>
              </div>
            ))}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', marginTop: '12px' }}>
              <button className="pixel-btn pixel-btn-blue" style={{ fontSize: '12px', padding: '8px' }}>✎ EDIT PROFILE</button>
              <button className="pixel-btn pixel-btn-green" style={{ fontSize: '12px', padding: '8px' }}>↺ RESET PORTFOLIO</button>
              <button onClick={handleSignOut} className="pixel-btn pixel-btn-red" style={{ fontSize: '12px', padding: '8px' }}>✕ SIGN OUT</button>
            </div>
          ...
          <div className="retro-card" style={{ padding: '14px', gridColumn: '1 / -1', borderColor: '#ff335544' }}>
            <div style={{ fontSize: '13px', color: '#ff3355', textShadow: '0 0 8px #ff3355', marginBottom: '10px' }}>⚠ DANGER ZONE</div>
            <div style={{ fontSize: '12px', color: '#64748b', lineHeight: 1.9, marginBottom: '10px' }}>
            ...
            <button
              ...
              style={{ fontSize: '12px', padding: '8px 14px', opacity: deleting ? 0.6 : 1 }}
            >
      ...
      {tab === 'upgrade' && (
        <div>
          <div style={{ fontSize: '13px', color: '#64748b', marginBottom: '14px', textAlign: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            {PLANS.map(plan => (
              ...
              >
                {plan.current && (
                  <div style={{ position: 'absolute', top: '-2px', left: '50%', transform: 'translateX(-50%)', background: '#64748b', padding: '2px 10px', fontSize: '11px', color: '#fff', whiteSpace: 'nowrap' }}>
                    CURRENT PLAN
                  </div>
                )}
                {plan.name === 'LEGEND' && !plan.current && (
                  <div style={{ position: 'absolute', top: '-2px', left: '50%', transform: 'translateX(-50%)', background: '#ffd700', padding: '2px 10px', fontSize: '11px', color: '#000', whiteSpace: 'nowrap' }}>
                    ★ BEST VALUE
                  </div>
                )}
                ...
                {plan.features.map(f => (
                  <div key={f} style={{ fontSize: '11px', color: '#64748b', padding: '4px 0', borderBottom: '1px solid #0f1629', textAlign: 'left' }}>
                ...
                <button
                  ...
                  style={{
                    width: '100%', fontSize: '13px', padding: '10px', marginTop: '14px',
